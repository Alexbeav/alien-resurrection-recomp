...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Alien Resurrection",
    .project_root_env = "ALIEN_RESURRECTION_RECOMP_PROJECT_ROOT",
    .build_dir_env = "ALIEN_RESURRECTION_RECOMP_BUILD_DIR",
    .force_setup_env = "ALIEN_RESURRECTION_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_029.13_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Alien_Resurrection__Recompiled",
    .prepare_note =
